						...
						{projects.map((project) => {
							return (
								<div
									...
									key={project.key}
									className={`Project ${
										project.url != null ? 'Project--clickable' : ''
									} ${
										project.key === 'inProgress' ? 'Project--in-progress' : ''
									}`}
								>
									...
									<div className="Project__body">
										<h3 className="Project__title">{project.label}</h3>
									...
									<div className="Project__footer">
										<div className="Project__tech-pills">
											{project.tools.map((tool) => {
												return (
													<div
														key={`${project.key}-${tool}`}
														className="Project__tech-pill"
													>
														{tool}
													</div>
												);
