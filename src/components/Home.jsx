    ...
    <div className="Home">
      <section id="hero" className="Home__section Home__section--hero">
        <div className="Home__section-info-main">
          <p className="Home__section-line1" style={{animationDelay: '200ms'}}>Hello, my name is</p>

          <h1 className="Home__section-line2" style={{animationDelay: '600ms'}}>Thendup Tsering.</h1>

          <p className="Home__section-line3" style={{animationDelay: '800ms'}}>
            I am a senior front-end react developer based in Toronto, Canada
          </p>

          <div className="Home__section-buttons Home__section-line4" style={{animationDelay: '1200ms'}}>
