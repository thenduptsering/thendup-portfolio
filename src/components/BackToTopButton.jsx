...
export default function BackToTopButton() {
	...
	const maxScrollY =
		rect != null ? Math.floor(rect.height - window.innerHeight) : null;
	...
	return (
		<div
			...
			className={`Back-To-Top-Button ${
				showButton ? 'Back-To-Top-Button--active' : ''
			}`}
		>
			<div className="Back-To-Top-Button__contents">
				<svg
					className="Back-To-Top-Button__progress"
					width={cDimension}
					height={cDimension}
				>
					<circle
						ref={circleRef}
						className="Back-To-Top-Button__progress-bar"
						cx={cCenter}
						cy={cCenter}
						r={cRadius}
					></circle>
